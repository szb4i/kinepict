...
def FrangiFilter2D(I, FrangiScaleRange=np.array([1, 10]), FrangiScaleRatio=2,
    ...
    :return:    J : The vessel enhanced image (pixel is the maximum found in all scales)
                Scale : Matrix with the scales on which the maximum intensity  f every pixel is found
